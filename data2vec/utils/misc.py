...
def save_model(epoch: int, avg_val_loss: float, save_path: str, net: nn.Module, optimizer : optim.Optimizer = None, log_file : str = None) -> None:
    """Saves checkpoint.
    ...
    log_message = f"Saved {save_path} with avg. loss {avg_val_loss}."
    print(log_message)
